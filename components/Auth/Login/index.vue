<template>
  <div class="p-4 rounded-lg border shadow border-gray-200 bg-white dark:bg-gray-800 dark:border-gray-700 w-sm space-y-6 text-center items-center">
...
<div class="flex w-full justify-end px-2">
  <button class="bg-gray-100 hover:bg-gray-200  dark:bg-gray-700  hover:dark:bg-gray-600 transition duration-200 rounded-lg px-2 py-1">Submit</button>
</div>
